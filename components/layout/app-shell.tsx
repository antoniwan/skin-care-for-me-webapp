  ...
  return (
    <div className="flex min-h-dvh bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col lg:pl-56">
        <header className="sticky top-0 z-30 flex items-center justify-between gap-3 overflow-visible border-b border-border bg-card/90 px-4 py-3 shadow-sm backdrop-blur-md lg:hidden">
          <Link
            href="/"
