...
**Success gate:** Users who enable reminders return to Today 2×/day in dogfood cohort.

**Dependencies:** Phase 1 scheduling; notification permission UX patterns.
...
| **Multi-device sync** | Encrypted shelf + settings |
| **Shared routines** | Export share link or household profile |
...
4. **Expand platform** (sync, scan) only after retention proof
